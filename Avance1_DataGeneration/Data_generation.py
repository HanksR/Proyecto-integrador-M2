...
class DataGenerator:
    ...
    def generate_vehicles(self, count=200):
        """Generar 200  con diferentes tipos y capacidades"""
        ...
        # Insertar en batch  __________________  query 1  ->  Completado
        query = """
    ...
    def generate_deliveries(self, count=400000):
        ...
        # Obtener todos los trips con su información  ____________ query 2  ->  Completado
        self.cursor.execute("""
        ...
        for trip_id, departure, arrival, total_weight, city in tqdm(trips_data, desc="Generando deliveries"):
            ...
            for i in range(num_deliveries):
                ...
                deliveries.append((
                    ...
                    float(round(package_weight, 2)),   # convertir a float nativo
                    scheduled,
                    delivered,
                    str(delivery_status),
                    bool(signature)
    ...
    def generate_maintenance(self, count=5000):
        ...
        # Obtener información de vehículos y sus viajes   _________ query 3  ->  Completado
        self.cursor.execute("""
            SELECT v.vehicle_id, v.vehicle_type, COUNT(t.trip_id), MIN(t.departure_datetime), MAX(t.departure_datetime)
            FROM vehicles v
